...
//   void list_merge_insert(node*& head_ptr, const node::value_type& entry)
//     Precondition: head_ptr is the head pointer of a linked list.
//     Postcondition: A new node containing the given entry has been added at
//     the end of the linked list; head_ptr now points to the head of the new,
//     longer linked list.
//
...
//   list_piece.
#ifndef ASSIGNMENT_5_NODE1_H
#define ASSIGNMENT_5_NODE1_H
...
void list_merge_insert(node *&head_ptr, node *&previous_ptr, const node::value_type &entry);
